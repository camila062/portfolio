...
<head>
    ...
    <!-- Bootstrap -->
    <link rel="stylesheet" href="public/site/public/bootstrap/css/bootstrap.min.css">

    <!-- meu icomoon -->
    <link rel="stylesheet" href="public/site/public/fonts/icomoon/icomoon.css">

    <!-- Meu css -->
    <link rel="stylesheet" href="public/site/public/css/meucss.css">
        ...
        <div class="collapse navbar-collapse" id="conteudoNavbarSuportado">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="site.php?pg=inicial">Inicial <span class="sr-only"></span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" href="site.php?pg=sobre">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="site.php?pg=produtos">
                        <span class="Mila-cart"></span> Produtos
                    </a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link" href="site.php?pg=contato">
            ...
            <ul class="navbar-nav text-lg-right">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="site.php?pg=cadastro">
                            <span class="Mila-cogs"></span> Meu Perfil
                        </a>
                        <a class="dropdown-item" href="site.php?pg=cadastro">
                            <span class="Mila-lock2"></span> Mudar Senha
                        </a>
                        <a class="dropdown-item" href="site.php?pg=carrinho">
                            <span class="Mila-truck1"></span> Meus Pedidos
                        </a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="site.php?pg=inicial">
